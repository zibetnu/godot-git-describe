...
func run_checks() -> void:
	set_pressed_colorful(platform_configured, Utilities.is_platform_configured())
	set_pressed_colorful(repository_found, Utilities.is_git_repository_found())
	set_pressed_colorful(git_found, Utilities.is_git_found())
	set_pressed_colorful(git_status_ok, Utilities.execute("git status").exit_code == 0)
